class UsersController < ApplicationController
  ...
  def destroy
    _notice_ = 'User successfully deleted.'
    begin
      ...
      _notice_ = "User has not been deleted due to some kind of a system problem or #{$!}."
    end
    respond_to do |format|
      format.html { redirect_to('/users', :notice => _notice_) }
    end
  end
  ...
  def create
    ...
    begin
      ...
      _notice_ = "User has not been added due to some kind of a system problem or #{$!}."
      respond_to do |format|
        format.html { redirect_to('/users', :notice => _notice_) }
      end
    end
