AnalyticsPortal::Application.routes.draw do
  ...
  #match 'filter_pref_destroy/:id', :to => 'filter_prefs#destroy'
...
#  resources :report_queries
  ...
  match '/users/chgpasswd', :to => 'devise#chgpasswd'
  match 'csv_reports/sample', :to => 'csv_reports#sample'
  match 'csv_reports/dorequest', :to => 'csv_reports#dorequest'
  match 'csv_reports/index', :to => 'csv_reports#index'
