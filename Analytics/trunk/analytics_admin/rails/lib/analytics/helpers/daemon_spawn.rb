...
#Adding this source, as it will perform better within JRuby's JIT Compilation
...
#
# = Description
#   JRuby implementation of C/Ruby Fork/Exec for FFI Capable Platforms
# = Todo
# == Upcoming Features
# 0. Nothing yet.
# == Known Issues
# 0. Does not work on Windows.
# == References
# 0. http://pubs.opengroup.org/onlinepubs/009695399/functions/posix_spawn.html
...
module DaemonSpawn
  ...
  if (RbConfig::CONFIG['host_os'] =~ /mswin|mingw|cygwin/)
    #TODO: [WARNING] Windows spawn not reliable!\
  else
